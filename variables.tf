...
variable "vm_compute_shape" {
  description = "Compute Shape with MIG Support"
  default     = "BM.GPU4.8"
}
...
variable "docker_image_name" {
  description = "Image name to pull from the registry"
  default = ""
}
...
variable "registry_username" {
  description = "Username for non-default registry"
  default = ""
}

variable "registry_password" {
  description = "Password for non-default registry"
  default = ""
}

variable "mig_number_devices" {
  description = "Number of GPU devices to create with MIGy"
  default = 16
}
